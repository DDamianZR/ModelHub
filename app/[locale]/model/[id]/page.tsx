                  ...
                  {scores.map((score) => (
                    <tr key={score.benchmark_id} className="border-b border-subtle">
                      <th scope="row" className="py-2 pr-3 text-sm font-normal">
                        ...
                        {/* Training-contamination evidence on this benchmark. Anti-bias
                            rule 4: the flag exists in the data and is stated here rather
                            than being carried silently into the composite. */}
